function conversion() {
    ...
    let junio2010 = 25.8; let julio2010 = 28.6; let agosto2010 = 30.1;
    //Variable para las temperaturas en 2015 en celsius
    let junio2015 = 26.5; let julio2015 = 29.3; let agosto2015 = 30.8;
    //Variable para las temperaturas en 2020 en celsius
    let junio2020 = 27.2; let julio2020 = 29.9; let agosto2020 = 31.5;
    ...
    //Variables para comprobar si ha superado 30 grados celsius alguna media con operador ternario
    let superado2010 = (mediana2010 > 30.0 ? true : false);
    let superado2015 = (mediana2015 > 30.0 ? true : false);
    let superado2020 = (mediana2020 > 30.0 ? true : false);
    //conversion de celsius a fahrenheit con la formula Fahrenheit = (Celsius * 9/5) + 32
    ...
    //conversion de celsius a kelvin con la formula Kelvin = Celsius + 273.15
    ...
    //Resultados de 2010 mostrados en consola
    ...
    //Resultados de 2015 mostrados en consola
    ...
    console.log("se han superado los 30 grados celsius de media en 2015: "+superado2015);
    //Resultados de 2020 mostrados en consola
    ...
    console.log("se han superado los 30 grados celsius de media en 2020: "+superado2020);
}

//Llamada a la funcion de conversión de temperaturas
conversion();